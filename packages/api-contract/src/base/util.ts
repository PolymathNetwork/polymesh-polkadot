...
import { ApiTypes, DecorateMethod, DecoratedRpc, SubmittableExtrinsicsExact } from '@polkadot/api/types';
...
export abstract class BaseWithTx<ApiType extends ApiTypes> extends Base<ApiType> {
  protected get apiContracts (): SubmittableExtrinsicsExact<'rxjs'>['contracts'] {
