...
import { AssetRule, AssetType, AuthorizationData, Ballot, ClaimRecord, ClaimValue, IdentifierType, IdentityId, MipsIndex, OffChainSignature, Permission, ProportionMatch, Signer, SigningItem, SigningItemWithAuth, TargetIdAuthorization, Ticker } from '@polkadot/types/interfaces/polymesh';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    balances: {
       ...
       */
      topUpIdentityBalance: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, value: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Claim back poly from an identity. Can only be called by master key of the identity
       */
      reclaimIdentityBalance: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, value: Compact<Balance> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Change setting that governs if user pays fee via their own balance or identity's balance
       */
      changeChargeDidFlag: AugmentedSubmittable<(chargeDid: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
    ...
    staking: {
       ...
       */
      addPotentialValidator: AugmentedSubmittable<(controller: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      removeValidator: AugmentedSubmittable<(controller: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Governance committee on 2/3 rds majority can update the compliance status of a validator as `Pending`
       */
      complianceFailed: AugmentedSubmittable<(controller: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Governance committee on 2/3 rds majority can update the compliance status of a validator as `Active`
       */
      compliancePassed: AugmentedSubmittable<(controller: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      validateKycExpiryNominators: AugmentedSubmittable<(targets: Vec<AccountId> | (AccountId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
    ...
    sudo: {
       ...
       */
      sudoAs: AugmentedSubmittable<(who: Address | string | AccountId | AccountIndex | Uint8Array, proposal: Proposal | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    multiSig: {
       ...
       */
      createMultisig: AugmentedSubmittable<(signers: Vec<Signer> | (Signer | { identity: any } | { accountKey: any } | string | Uint8Array)[], sigsRequired: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      createProposalAsIdentity: AugmentedSubmittable<(multisig: AccountId | string | Uint8Array, proposal: Proposal | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Creates a multisig proposal
       *
       * @param multisig - MultiSig address
       * @param proposal - Proposal to be voted on
       */
      createProposalAsKey: AugmentedSubmittable<(multisig: AccountId | string | Uint8Array, proposal: Proposal | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      approveAsIdentity: AugmentedSubmittable<(multisig: AccountId | string | Uint8Array, proposalId: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param proposal_id - Proposal id to approve
       */
      approveAsKey: AugmentedSubmittable<(multisig: AccountId | string | Uint8Array, proposalId: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param multisig - MultiSig address
       */
      addMultisigSigner: AugmentedSubmittable<(signer: Signer | { identity: any } | { accountKey: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Remove a signer from the multisig. This must be called by the multisig itself
       *
       * @param multisig - MultiSig address
       */
      removeMultisigSigner: AugmentedSubmittable<(signer: Signer | { identity: any } | { accountKey: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
    ...
    polymeshCommittee: {
       ...
       */
      setVoteThreshold: AugmentedSubmittable<(matchCriteria: ProportionMatch | ('AtLeast' | 'MoreThan') | number | Uint8Array, n: u32 | AnyNumber | Uint8Array, d: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Set the committee's membership manually to `new_members`. Requires root origin
       *
       * @param origin - Root
       */
      setMembers: AugmentedSubmittable<(newMembers: Vec<IdentityId> | (IdentityId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Any committee member proposes a dispatchable
       *
       * @param did - Identity of the proposer
       */
      propose: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, proposal: Proposal | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Member casts a vote
       *
       * @param did - Identity of the proposer
       ...
       */
      vote: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, proposal: Hash | string | Uint8Array, index: Compact<ProposalIndex> | AnyNumber | Uint8Array, approve: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    committeeMembership: {
       ...
       */
      addMember: AugmentedSubmittable<(who: IdentityId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      removeMember: AugmentedSubmittable<(who: IdentityId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      swapMember: AugmentedSubmittable<(remove: IdentityId | string | Uint8Array, add: IdentityId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      resetMembers: AugmentedSubmittable<(members: Vec<IdentityId> | (IdentityId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
    };
    mips: {
       ...
       */
      setMinProposalDeposit: AugmentedSubmittable<(deposit: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      setQuorumThreshold: AugmentedSubmittable<(threshold: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      setProposalDuration: AugmentedSubmittable<(duration: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      propose: AugmentedSubmittable<(proposal: Proposal | { callIndex?: any; args?: any } | string | Uint8Array, deposit: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      vote: AugmentedSubmittable<(proposalHash: Hash | string | Uint8Array, index: MipsIndex | AnyNumber | Uint8Array, ayeOrNay: bool | boolean | Uint8Array, deposit: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * An emergency stop measure to kill a proposal. Governance committee can kill a proposal at any time
       */
      killProposal: AugmentedSubmittable<(index: MipsIndex | AnyNumber | Uint8Array, proposalHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * An emergency stop measure to kill a proposal. Governance committee can kill a proposal at any time
       */
      fastTrackProposal: AugmentedSubmittable<(index: MipsIndex | AnyNumber | Uint8Array, proposalHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      emergencyReferendum: AugmentedSubmittable<(proposal: Proposal | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Moves a referendum instance into dispatch queue
       */
      enactReferendum: AugmentedSubmittable<(proposalHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    asset: {
       ...
       */
      registerTicker: AugmentedSubmittable<(ticker: Ticker | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param origin - It contains the signing key of the caller (i.e who signed the transaction to execute this function)
       */
      acceptTokenOwnershipTransfer: AugmentedSubmittable<(authId: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      renameToken: AugmentedSubmittable<(ticker: Ticker | string | Uint8Array, name: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      transfer: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, toDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      controllerTransfer: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, fromDid: IdentityId | string | Uint8Array, toDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array, operatorData: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      approve: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, spenderDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      transferFrom: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, fromDid: IdentityId | string | Uint8Array, toDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      createCheckpoint: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      issue: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, toDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      batchIssue: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, investorDids: Vec<IdentityId> | (IdentityId | string | Uint8Array)[], values: Vec<Balance> | (Balance | AnyNumber | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      redeem: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param value - Amount of the tokens needs to redeem
       */
      redeemFrom: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, fromDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      controllerRedeem: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, tokenHolderDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array, operatorData: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param did - DID of the token owner
       */
      makeDivisible: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      canTransfer: AugmentedSubmittable<(ticker: Ticker | string | Uint8Array, fromDid: IdentityId | string | Uint8Array, toDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param value - Amount of the tokens
       */
      transferWithData: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, toDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param value - Amount of the tokens
       */
      transferFromWithData: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, fromDid: IdentityId | string | Uint8Array, toDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Used to know whether the given token will issue new tokens or not
       *
       * @param _origin - Signing key
       */
      isIssuable: AugmentedSubmittable<(ticker: Ticker | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param ticker - Ticker of the token
       */
      getDocument: AugmentedSubmittable<(ticker: Ticker | string | Uint8Array, name: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      setDocument: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, name: Bytes | string | Uint8Array, uri: Bytes | string | Uint8Array, documentHash: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param ticker - Ticker of the token
       */
      removeDocument: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, name: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      increaseCustodyAllowance: AugmentedSubmittable<(ticker: Ticker | string | Uint8Array, holderDid: IdentityId | string | Uint8Array, custodianDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      increaseCustodyAllowanceOf: AugmentedSubmittable<(ticker: Ticker | string | Uint8Array, holderDid: IdentityId | string | Uint8Array, holderAccountId: AccountId | string | Uint8Array, custodianDid: IdentityId | string | Uint8Array, callerDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array, nonce: u16 | AnyNumber | Uint8Array, signature: OffChainSignature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      transferByCustodian: AugmentedSubmittable<(ticker: Ticker | string | Uint8Array, holderDid: IdentityId | string | Uint8Array, custodianDid: IdentityId | string | Uint8Array, receiverDid: IdentityId | string | Uint8Array, value: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param ticker - The ticker of the token
       */
      setFundingRound: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, name: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
    ...
    dividend: {
       ...
       */
      new: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array, ticker: Ticker | string | Uint8Array, maturesAt: Moment | AnyNumber | Uint8Array, expiresAt: Moment | AnyNumber | Uint8Array, payoutTicker: Ticker | string | Uint8Array, checkpointId: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Lets the owner cancel a dividend before start/maturity date
       */
      cancel: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, dividendId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      claim: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, dividendId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * After a dividend had expired, collect the remaining amount to owner address
       */
      claimUnclaimed: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, dividendId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    identity: {
       ...
       */
      registerDid: AugmentedSubmittable<(signingItems: Vec<SigningItem> | (SigningItem | { signer?: any; signer_type?: any; permissions?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Adds new signing keys for a DID. Only called by master key owner
       */
      addSigningItems: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, signingItems: Vec<SigningItem> | (SigningItem | { signer?: any; signer_type?: any; permissions?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes specified signing keys of a DID if present
       */
      removeSigningItems: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, signersToRemove: Vec<Signer> | (Signer | { identity: any } | { accountKey: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Sets a new master key for a DID
       */
      setMasterKey: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, newKey: Key | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Adds new claim record or edits an existing one. Only called by did_issuer's signing key
       */
      addClaim: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, claimKey: Bytes | string | Uint8Array, didIssuer: IdentityId | string | Uint8Array, expiry: Moment | AnyNumber | Uint8Array, claimValue: ClaimValue | { data_type?: any; value?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Adds a new batch of claim records or edits an existing one. Only called by `did_issuer`'s signing key
       */
      addClaimsBatch: AugmentedSubmittable<(didIssuer: IdentityId | string | Uint8Array, claims: Vec<ClaimRecord> | (ClaimRecord | { did?: any; claim_key?: any; expiry?: any; claim_value?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      forwardedCall: AugmentedSubmittable<(targetDid: IdentityId | string | Uint8Array, proposal: Proposal | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Marks the specified claim as revoked
       */
      revokeClaim: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, claimKey: Bytes | string | Uint8Array, didIssuer: IdentityId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      setPermissionToSigner: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, signer: Signer | { identity: any } | { accountKey: any } | string | Uint8Array, permissions: Vec<Permission> | (Permission | ('Full' | 'Admin' | 'Operator' | 'SpendFunds') | number | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * It disables all signing keys at `did` identity
       */
      freezeSigningKeys: AugmentedSubmittable<(did: IdentityId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      unfreezeSigningKeys: AugmentedSubmittable<(did: IdentityId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      getMyDid: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>>;
      /**
       * Adds an authorization
       */
      addAuthorization: AugmentedSubmittable<(target: Signer | { identity: any } | { accountKey: any } | string | Uint8Array, authorizationData: AuthorizationData | { attestMasterKeyRotation: any } | { rotateMasterKey: any } | { transferTicker: any } | { addMultiSigSigner: any } | { transferTokenOwnership: any } | { custom: any } | { noData: any } | string | Uint8Array, expiry: Option<Moment> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Adds an authorization as a key. To be used by signing keys that don't have an identity
       */
      addAuthorizationAsKey: AugmentedSubmittable<(target: Signer | { identity: any } | { accountKey: any } | string | Uint8Array, authorizationData: AuthorizationData | { attestMasterKeyRotation: any } | { rotateMasterKey: any } | { transferTicker: any } | { addMultiSigSigner: any } | { transferTokenOwnership: any } | { custom: any } | { noData: any } | string | Uint8Array, expiry: Option<Moment> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Adds an array of authorization
       */
      batchAddAuthorization: AugmentedSubmittable<(auths: Vec<ITuple<[Signer, AuthorizationData, Option<Moment>]>> | ([Signer | { identity: any } | { accountKey: any } | string | Uint8Array, AuthorizationData | { attestMasterKeyRotation: any } | { rotateMasterKey: any } | { transferTicker: any } | { addMultiSigSigner: any } | { transferTokenOwnership: any } | { custom: any } | { noData: any } | string | Uint8Array, Option<Moment> | null | object | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes an authorization
       */
      removeAuthorization: AugmentedSubmittable<(target: Signer | { identity: any } | { accountKey: any } | string | Uint8Array, authId: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes an array of authorizations
       */
      batchRemoveAuthorization: AugmentedSubmittable<(authIdentifiers: Vec<ITuple<[Signer, u64]>> | ([Signer | { identity: any } | { accountKey: any } | string | Uint8Array, u64 | AnyNumber | Uint8Array])[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * Accepts an authorization
       */
      acceptAuthorization: AugmentedSubmittable<(authId: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Accepts an array of authorizations
       */
      batchAcceptAuthorization: AugmentedSubmittable<(authIds: Vec<u64> | (u64 | AnyNumber | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       * The key designated by `origin` accepts the authorization to join to `target_id` Identity
       */
      authorizeJoinToIdentity: AugmentedSubmittable<(targetId: IdentityId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      unauthorizedJoinToIdentity: AugmentedSubmittable<(signer: Signer | { identity: any } | { accountKey: any } | string | Uint8Array, targetId: IdentityId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      addSigningItemsWithAuthorization: AugmentedSubmittable<(id: IdentityId | string | Uint8Array, expiresAt: Moment | AnyNumber | Uint8Array, additionalKeys: Vec<SigningItemWithAuth> | (SigningItemWithAuth | { signing_item?: any; auth_signature?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      revokeOffchainAuthorization: AugmentedSubmittable<(signer: Signer | { identity: any } | { accountKey: any } | string | Uint8Array, auth: TargetIdAuthorization | { target_id?: any; nonce?: any; expires_at?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Query whether given signer identity has valid KYC or not
       *
       * @param origin - Signer whose identity get checked
       */
      isMyIdentityHasValidKyc: AugmentedSubmittable<(bufferTime: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    generalTm: {
       ...
       */
      addActiveRule: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, assetRule: AssetRule | { sender_rules?: any; receiver_rules?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes a rule from active asset rules
       */
      removeActiveRule: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, assetRule: AssetRule | { sender_rules?: any; receiver_rules?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes all active rules of a ticker
       */
      resetActiveRules: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    voting: {
       ...
       */
      addBallot: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, ballotName: Bytes | string | Uint8Array, ballotDetails: Ballot | { checkpoint_id?: any; voting_start?: any; voting_end?: any; motions?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Casts a vote
       *
       ...
       * @param ballot_name - Name of the ballot
       */
      vote: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, ballotName: Bytes | string | Uint8Array, votes: Vec<Balance> | (Balance | AnyNumber | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      cancelBallot: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, ballotName: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    stoCapped: {
       ...
       */
      launchSto: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, beneficiaryDid: IdentityId | string | Uint8Array, cap: Balance | AnyNumber | Uint8Array, rate: u128 | AnyNumber | Uint8Array, startDate: Moment | AnyNumber | Uint8Array, endDate: Moment | AnyNumber | Uint8Array, simpleTokenTicker: Ticker | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Used to buy tokens
       *
       ...
       */
      buyTokens: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, stoId: u32 | AnyNumber | Uint8Array, value: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      modifyAllowedTokens: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, stoId: u32 | AnyNumber | Uint8Array, simpleTokenTicker: Ticker | string | Uint8Array, modifyStatus: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      buyTokensBySimpleToken: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, stoId: u32 | AnyNumber | Uint8Array, value: Balance | AnyNumber | Uint8Array, simpleTokenTicker: Ticker | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param ticker - Ticker of the token
       */
      pauseSto: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, stoId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * @param ticker - Ticker of the token
       */
      unpauseSto: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, stoId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    percentageTm: {
       ...
       */
      toggleMaximumPercentageRestriction: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, maxPercentage: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    exemption: {

      modifyExemptionList: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, tm: u16 | AnyNumber | Uint8Array, assetHolderDid: IdentityId | string | Uint8Array, exempted: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    simpleToken: {
       ...
       */
      createToken: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, totalSupply: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       */
      transfer: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, toDid: IdentityId | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Transfer tokens to another identity using the approval mechanic
       */
      transferFrom: AugmentedSubmittable<(did: IdentityId | string | Uint8Array, ticker: Ticker | string | Uint8Array, fromDid: IdentityId | string | Uint8Array, toDid: IdentityId | string | Uint8Array, amount: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    kycServiceProviders: {
